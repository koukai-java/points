...
public class Keiketsu {
	...
	public Keiketsu(String id, String meridian, String furigana, String name, String location, String specific, String learn, String q_location, String ans_location, String q_specific, String ans_specific) {
		this.id = id;
